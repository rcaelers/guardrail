...
use entities::entity;
use entities::model::base::Repo;
use entities::model::version::VersionRepo;
...
impl MinidumpApi {
    ...
    ) -> Result<entities::model::product::Product, ApiError> {
    ...
    async fn get_version(
        ...
        params: &MinidumpRequestParams,
    ) -> Result<entities::model::version::Version, ApiError> {
        let version =
    ...
    async fn store_crash(
        ...
        product: entities::model::product::Product,
        version: entities::model::version::Version,
        state: &AppState,
