...
where
    Self: leptos_struct_table::TableDataProvider<Self::RowType, usize>
        + ExtraTableDataProvider<Self::RowType>
        + Clone
        + Sync
        + Send
        + 'static,
    <Self::RowType as leptos_struct_table::TableRow<usize>>::ClassesProvider: Send + Sync,
{
    type RowType: leptos_struct_table::TableRow<usize>
        + ExtraRowTrait
        + Sync
        + Send
        + Clone
